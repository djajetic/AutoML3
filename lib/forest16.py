# this file is tree sklearn 0.16 backport created by aad_freiburg team and should be used only if sklearn < 0.16 is installed
# otherwise should be deleted (warm start was not important in phase 3, and it was (probably) not used in AutoML 3)
# sklearn is copyrighted with BSD 3-Clause licence
